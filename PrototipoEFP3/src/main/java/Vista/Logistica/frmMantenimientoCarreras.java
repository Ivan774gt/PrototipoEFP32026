...
public class frmMantenimientoCarreras extends javax.swing.JInternalFrame  {
  javax.swing.table.DefaultTableModel modeloLocal;
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(frmMantenimientoCarreras.class.getName());
    ...
    private void initComponents() {
        ...
        tablaUsuarios1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Carrera", "Nombre Carrera", "ID Facultad", "Estatus"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        label21.setText("Nombre Carrera");
  ...
  String idBuscado = txtbuscado1.getText().trim();
        ...
        clsCarreras carrera = dao.buscarPorId(String.valueOf(idBuscado));

        if (carrera != null) {
            txtIdprod.setText(String.valueOf(carrera.getCodigoCarrera()));
            txtNombreProd.setText(carrera.getNombreCarrera());
            txtStockProd.setText(carrera.getCodigoFacultad());
            txtProdReorden.setText(carrera.getEstatusCarrera());
   ...
   try {
            ...
            carrera.setCodigoCarrera(txtIdprod.getText());
            carrera.setNombreCarrera(txtNombreProd.getText());
            carrera.setCodigoFacultad(txtStockProd.getText());
            carrera.setEstatusCarrera(txtProdReorden.getText());
...
try {
   ...
   String idEliminar = txtbuscado1.getText();
        ...
        if (respuesta == JOptionPane.YES_OPTION) {
            CarrerasDAO dao = new CarrerasDAO();
            if (dao.eliminar(String.valueOf(idEliminar))) {
  ...
  DefaultTableModel modelo = new DefaultTableModel();
        ...
        modelo.addColumn("NombreCarrera");
        ...
        for (clsCarreras prod : lista) {
            fila[0] = prod.getCodigoCarrera();
            fila[1] = prod.getNombreCarrera();
            fila[2] = prod.getCodigoFacultad();
            fila[3] = prod.getEstatusCarrera();
            modelo.addRow(fila);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new frmMantenimientoCarreras().setVisible(true));
    }
